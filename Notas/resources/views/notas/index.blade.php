                                    ...
                                    <tr class="font-semibold text-center border-t border-black text-black">
                                        ...
                                        <td class="px-4 py-3 flex items-center text-green-600">
                                            <a href="{{ url('/notas/' . $nota->id) }}" title="View nota"><button
                                                class="inline-flex m-1"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                                    <path stroke-linecap="round" stroke-linejoin="round" d="M8.625 12a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H12m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                                  </svg>                                                                                                                                          
                                            </button></a>
                                        <a href="{{ url('/notas/' . $nota->id . '/edit') }}"
                                            title="Edit nota"><button class="inline-flex m-1"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                        ...
                                        <form method="POST" action="{{ url('/notas' . '/' . $nota->id) }}"
                                            ...
                                            <button type="submit" class="inline-flex m-1" title="Delete nota"
                                                onclick="return confirm(&quot;¿estas seguro?&quot;)"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
